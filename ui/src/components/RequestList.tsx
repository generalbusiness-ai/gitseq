...
import { age, matchingRows, POPULATIONS, sortAfterClick, sortRows, workRows, type Population, type Sort, type SortKey, type WorkRow } from "../lib/rows";
...
export function RequestList({
  ...
  const populations = useMemo(
    () =>
      Object.fromEntries(
        POPULATIONS.map(({ key }) => [key, projection ? workRows(projection, context, key) : []]),
