...
commit `fa4e402a2568eed4445c573a1cf4096fe1642b39`, with contract digest
...
| --- | --- | --- |
| Exact-head status at or below 500 ms | Complete cold and warm status samples at a named depth | **Not yet measurable.** Depth-100 cold was 4.47 s and warm was 8.4 ms, but one sample cannot establish a representative exact-head distribution. |
| A tail of at most 10 events at or below 2 s | Checkpoint restart with tail 0, 1, and 10 | **Met in this smoke observation.** The three samples were 326 ms, 340 ms, and 774 ms. Repeat the standard population before treating this as stable evidence. |
...
pairs. Its soak reached the 60-second ceiling after 570 of the possible 1,000
