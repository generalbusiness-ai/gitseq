...
func TestReceiptAccountingRejectsFold19ProjectionCache(t *testing.T) {
	...
	workspace.snapshotProfile = apphost.DefaultApplication + "\x00workroom-fold@19"
	...
	if workspace.snapshotProfile != apphost.DefaultApplication+"\x00workroom-fold@20" {
