...
func TestAnOlderProfileCacheIsRebuiltUnderTheNewRules(t *testing.T) {
	...
	wantProfile := apphost.DefaultApplication + "\x00" + "workroom-fold@20"
...
func TestAwaitingReviewStatusRebuildsAnOlderProfileCache(t *testing.T) {
	...
	wantProfile := apphost.DefaultApplication + "\x00workroom-fold@20"
	workspace.snapshotMu.Lock()
...
func TestReassignSchemasRebuildAnOlderProfileCache(t *testing.T) {
	...
	want := apphost.DefaultApplication + "\x00workroom-fold@20"
