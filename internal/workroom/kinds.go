...
func starterCatalog() map[Kind]KindDefinition {
	definitions := []KindDefinition{
		...
		starter(KindReport, nil, countKinds(1, 1, KindPromise), SatisfierOriginatingRequester, RenderResult, LifecycleReport,
			"Report the result of exactly one promise with the tests and conditions actually met."),
