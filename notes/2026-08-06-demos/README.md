...
| [E](E-fork-the-institution.md) | Fork the institution | exit rights with stock git | a coda on A or C |

Build order **C → B → A** (cheapest first, flagship last); E rides
along as a closing beat; D stays absorbed until multi-log serving
exists. The bootstrap principle holds throughout: the demo runs on
this repository's real history, never a fixture world — including
the failed takes, which is the pitch.
