...
principal's signing key. Removal does not rewrite verdicts earned while the
principal was admitted, and restoring membership gives force only to later
states.
...
promise or other record, but neither author a new effective state, ratify a
report, nor supersede another actor's act.
