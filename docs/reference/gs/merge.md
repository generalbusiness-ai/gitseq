...
it under the profile version that carries it, and make omission a refusal only
after every resident and adapter has restarted on that binding. The profile transition is
